...
type BlogPostDocumentDataSlicesSlice = ImageBlockSlice | ProjectSlice;
...
interface BlogPostDocumentData {
  ...
  /**
   * go to label field in *Blog Post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.go_to_label
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  go_to_label: prismic.KeyTextField;
...
type ProjectDocumentDataSlicesSlice = ImageBlockSlice | ProjectSlice;
...
interface ProjectDocumentData {
  ...
  /**
   * go to label field in *Project*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project.go_to_label
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  go_to_label: prismic.KeyTextField;
...
export interface TechListSliceDefaultItem {
  /**
   * TechLogo field in *TechList → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.items[].techlogo
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  techlogo: prismic.ImageField<never>;
}
